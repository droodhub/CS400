...
public class Airport implements AirportInterface {
    ...
    private String code; //international travel code of the airport
     ...
     */
    public Airport(String code, String name, String city, String state, double latitude, double longitude) {
        this.code = code;
        this.name = name;
        this.city = city;
        this.state = state;
...
public String getCode(){return code;}
    ...
    public String toString() {
        return "(" + code + ")" + name + " | " + city + ", " + state + " | (" + latitude + ", " + longitude + ")";
    }
