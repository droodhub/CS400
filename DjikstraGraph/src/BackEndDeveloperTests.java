...
public class BackEndDeveloperTests {
  ...
  public void createBackend() {
    ...
    airport1 = new Airport("Airport1", "Bellingham", "WA", 48.7519, 122.4787);
    airport2 = new Airport("Airport2", "Seattle", "WA", 47.6062, 122.3321);
    airport3 = new Airport("Airport3", "Neenah", "WI", 44.1858, 88.4626);
    airport4 = new Airport("Airport4", "Madison", "WI", 43.0731, 89.4012);
    airport5 = new Airport("Airport5", "Milwaukee", "WI", 43.0389, 87.9065);
    airport6 = new Airport("Airport6", "Chicago", "IL", 41.8781, 87.6298);
    airport7 = new Airport("Airport7", "London", "UK", 51.5074, .1278);
